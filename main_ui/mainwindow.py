...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "pre-wirebonding DAQ", None))
        item = self.listAssembly.item(6)
        item.setText(_translate("MainWindow", "wirebonding", None))
        item = self.listAssembly.item(7)
        item.setText(_translate("MainWindow", "post-wirebonding 0v DAQ", None))
        item = self.listAssembly.item(8)
        item.setText(_translate("MainWindow", "post-wirebonding IV & biased DAQ", None))
        item = self.listAssembly.item(9)
        item.setText(_translate("MainWindow", "encapsulation", None))
        item = self.listAssembly.item(10)
        item.setText(_translate("MainWindow", "post-encapsulation 0v DAQ", None))
        item = self.listAssembly.item(11)
        item.setText(_translate("MainWindow", "post-encapsulation IV & biased DAQ", None))
