	...
	def updateIssues(self,*args,**kwargs):
		...
		if self.page.cbAdhesive.currentText() == "Araldite":
			...
			if self.batch_tape_50.ID is None and self.page.leTape50.text() != "":
				...
				if not (self.batch_tape_50.date_expires is None and not self.batch_tape_50.no_expiry):
			...
			if self.batch_tape_120.ID is None and self.page.leTape120.text() != "":
				...
				if not (self.batch_tape_120.date_expires is None and not self.batch_tape_120.no_expiry):
