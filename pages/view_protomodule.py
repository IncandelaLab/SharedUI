...
class func(object):
	...
	def update_info(self,ID=None,*args,**kwargs):
		...
		self.page.dsbOffsetTranslationX.setValue(-1001 if self.protomodule.snsr_x_offst is None else self.protomodule.snsr_x_offst )
		self.page.dsbOffsetTranslationY.setValue(-1001 if self.protomodule.snsr_y_offst is None else self.protomodule.snsr_y_offst )
		self.page.dsbOffsetRotation.setValue(    -1001 if self.protomodule.snsr_ang_offst    is None else self.protomodule.snsr_ang_offst    )
