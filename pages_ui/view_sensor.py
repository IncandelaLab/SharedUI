...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pbAddFiles.setGeometry(QtCore.QRect(720, 170, 101, 31))
        self.pbAddFiles.setObjectName("pbAddFiles")
        self.listFiles = QtWidgets.QListWidget(Form)
        self.listFiles.setGeometry(QtCore.QRect(590, 50, 351, 91))
        self.listFiles.setObjectName("listFiles")
        self.lineEdit_16 = QtWidgets.QLineEdit(Form)
        self.lineEdit_16.setGeometry(QtCore.QRect(591, 140, 221, 21))
        self.lineEdit_16.setReadOnly(True)
        self.lineEdit_16.setObjectName("lineEdit_16")
        self.pbDeleteFile = QtWidgets.QPushButton(Form)
        self.pbDeleteFile.setGeometry(QtCore.QRect(810, 140, 131, 21))
        self.pbDeleteFile.setObjectName("pbDeleteFile")
        self.label_7 = QtWidgets.QLabel(Form)
        self.label_7.setEnabled(True)
        self.label_7.setGeometry(QtCore.QRect(590, 30, 241, 16))
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit_16.setText(_translate("Form", "Testing data files"))
