...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame_2.setGeometry(QtCore.QRect(10, 110, 261, 521))
        ...
        self.sbChannels.setGeometry(QtCore.QRect(180, 240, 80, 21))
        ...
        self.label.setGeometry(QtCore.QRect(310, 516, 61, 16))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(Form)
        self.label_2.setGeometry(QtCore.QRect(310, 426, 131, 16))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(Form)
        self.label_3.setGeometry(QtCore.QRect(310, 366, 141, 16))
        self.label_3.setObjectName("label_3")
        self.lineEdit_15 = QtWidgets.QLineEdit(Form)
        self.lineEdit_15.setGeometry(QtCore.QRect(310, 386, 131, 21))
        self.lineEdit_15.setReadOnly(True)
        self.lineEdit_15.setObjectName("lineEdit_15")
        self.cbInspection = QtWidgets.QComboBox(Form)
        self.cbInspection.setGeometry(QtCore.QRect(440, 386, 121, 21))
        self.cbInspection.setObjectName("cbInspection")
        self.cbInspection.addItem("")
        self.cbInspection.addItem("")
        self.leProtomodule = QtWidgets.QLineEdit(Form)
        self.leProtomodule.setGeometry(QtCore.QRect(430, 466, 80, 20))
        self.leProtomodule.setReadOnly(True)
        self.leProtomodule.setObjectName("leProtomodule")
        self.leModule = QtWidgets.QLineEdit(Form)
        self.leModule.setGeometry(QtCore.QRect(430, 536, 80, 20))
        self.leModule.setReadOnly(True)
        self.leModule.setObjectName("leModule")
        self.label_4 = QtWidgets.QLabel(Form)
        self.label_4.setGeometry(QtCore.QRect(310, 173, 211, 16))
        self.label_4.setObjectName("label_4")
        self.frame_6 = QtWidgets.QFrame(Form)
        self.frame_6.setGeometry(QtCore.QRect(310, 254, 241, 81))
        self.frame_6.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_6.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_6.setObjectName("frame_6")
        self.dsbKaptonFlatness_2 = QtWidgets.QDoubleSpinBox(self.frame_6)
        self.dsbKaptonFlatness_2.setEnabled(False)
        self.dsbKaptonFlatness_2.setGeometry(QtCore.QRect(159, 40, 81, 20))
        self.dsbKaptonFlatness_2.setReadOnly(True)
        self.dsbKaptonFlatness_2.setDecimals(3)
        ...
        self.cbCheckEdgesFirm_2 = QtWidgets.QComboBox(self.frame_6)
        self.cbCheckEdgesFirm_2.setEnabled(False)
        self.cbCheckEdgesFirm_2.setGeometry(QtCore.QRect(159, 0, 81, 20))
        ...
        self.cbCheckGlueSpill_2 = QtWidgets.QComboBox(self.frame_6)
        self.cbCheckGlueSpill_2.setGeometry(QtCore.QRect(159, 20, 81, 20))
        ...
        self.dsbThickness_2 = QtWidgets.QDoubleSpinBox(self.frame_6)
        self.dsbThickness_2.setEnabled(False)
        self.dsbThickness_2.setGeometry(QtCore.QRect(160, 60, 79, 20))
        self.dsbThickness_2.setReadOnly(True)
        self.dsbThickness_2.setDecimals(3)
        self.dsbThickness_2.setMinimum(-1.0)
        self.dsbThickness_2.setMaximum(2147483647.0)
        self.dsbThickness_2.setSingleStep(0.05)
        self.dsbThickness_2.setObjectName("dsbThickness_2")
        self.label_6 = QtWidgets.QLabel(Form)
        self.label_6.setGeometry(QtCore.QRect(310, 233, 241, 16))
        self.label_6.setObjectName("label_6")
        self.frame_7 = QtWidgets.QFrame(Form)
        self.frame_7.setGeometry(QtCore.QRect(310, 193, 241, 21))
        self.frame_7.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_7.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_7.setObjectName("frame_7")
        self.pbGoStepKapton_2 = QtWidgets.QPushButton(self.frame_7)
        self.pbGoStepKapton_2.setGeometry(QtCore.QRect(190, 0, 51, 21))
        self.pbGoStepKapton_2.setObjectName("pbGoStepKapton_2")
        self.sbStepKapton_2 = QtWidgets.QSpinBox(self.frame_7)
        self.sbStepKapton_2.setGeometry(QtCore.QRect(110, 1, 81, 19))
        ...
        self.frame_8.setGeometry(QtCore.QRect(310, 51, 241, 81))
        self.frame_8.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_8.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_8.setObjectName("frame_8")
        self.dsbKaptonFlatness = QtWidgets.QDoubleSpinBox(self.frame_8)
        self.dsbKaptonFlatness.setEnabled(True)
        ...
        self.cbCheckEdgesFirm = QtWidgets.QComboBox(self.frame_8)
        self.cbCheckEdgesFirm.setEnabled(True)
        ...
        self.cbCheckEdgesFirm.addItem("")
        self.lineEdit_30 = QtWidgets.QLineEdit(self.frame_8)
        ...
        self.cbCheckGlueSpill = QtWidgets.QComboBox(self.frame_8)
        ...
        self.dsbThickness = QtWidgets.QDoubleSpinBox(self.frame_8)
        self.dsbThickness.setEnabled(True)
        ...
        self.label_5.setGeometry(QtCore.QRect(310, 30, 241, 16))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_5.setText(_translate("Form", "kaptonized baseplate qualification"))
