...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_4.setGeometry(QtCore.QRect(630, 570, 181, 21))
        self.label_4.setObjectName("label_4")
        self.frame_3 = QtWidgets.QFrame(Form)
        self.frame_3.setGeometry(QtCore.QRect(630, 600, 241, 41))
        ...
        self.frame_5.setGeometry(QtCore.QRect(310, 420, 241, 81))
        self.frame_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_5.setObjectName("frame_5")
        self.lineEdit_32 = QtWidgets.QLineEdit(self.frame_5)
        self.lineEdit_32.setGeometry(QtCore.QRect(1, 20, 151, 21))
        ...
        self.lineEdit_43.setGeometry(QtCore.QRect(0, 40, 151, 21))
        self.lineEdit_43.setReadOnly(True)
        self.lineEdit_43.setObjectName("lineEdit_43")
        self.lineEdit_44 = QtWidgets.QLineEdit(self.frame_5)
        self.lineEdit_44.setGeometry(QtCore.QRect(0, 60, 151, 21))
        ...
        self.lineEdit_34.setGeometry(QtCore.QRect(0, 20, 131, 21))
        self.lineEdit_34.setReadOnly(True)
        self.lineEdit_34.setObjectName("lineEdit_34")
        self.lineEdit_35 = QtWidgets.QLineEdit(self.frame_8)
        self.lineEdit_35.setGeometry(QtCore.QRect(0, 40, 131, 21))
        self.lineEdit_35.setReadOnly(True)
        self.lineEdit_35.setObjectName("lineEdit_35")
        self.leBatchSylgard = QtWidgets.QLineEdit(self.frame_8)
        self.leBatchSylgard.setGeometry(QtCore.QRect(130, 0, 101, 21))
        self.leBatchSylgard.setObjectName("leBatchSylgard")
        self.leBatchBondWire = QtWidgets.QLineEdit(self.frame_8)
        self.leBatchBondWire.setGeometry(QtCore.QRect(130, 20, 101, 21))
        self.leBatchBondWire.setObjectName("leBatchBondWire")
        self.leBatchWedge = QtWidgets.QLineEdit(self.frame_8)
        self.leBatchWedge.setGeometry(QtCore.QRect(130, 40, 101, 21))
        self.leBatchWedge.setObjectName("leBatchWedge")
        self.pbGoBatchSylgard = QtWidgets.QPushButton(self.frame_8)
        self.pbGoBatchSylgard.setGeometry(QtCore.QRect(230, 0, 51, 21))
        self.pbGoBatchSylgard.setObjectName("pbGoBatchSylgard")
        self.pbGoBatchBondWire = QtWidgets.QPushButton(self.frame_8)
        self.pbGoBatchBondWire.setGeometry(QtCore.QRect(230, 20, 51, 21))
        self.pbGoBatchBondWire.setObjectName("pbGoBatchBondWire")
        self.pbGoBatchWedge = QtWidgets.QPushButton(self.frame_8)
        self.pbGoBatchWedge.setGeometry(QtCore.QRect(230, 40, 51, 21))
        self.pbGoBatchWedge.setObjectName("pbGoBatchWedge")
        ...
        self.frame_10.setGeometry(QtCore.QRect(310, 20, 301, 391))
        ...
        self.frame.setGeometry(QtCore.QRect(10, 40, 281, 171))
        ...
        self.dWirebondingBack.setGeometry(QtCore.QRect(170, 40, 111, 21))
        ...
        self.lineEdit_15.setGeometry(QtCore.QRect(0, 40, 171, 21))
        ...
        self.pbBondStartNowBack = QtWidgets.QPushButton(self.frame)
        self.pbBondStartNowBack.setGeometry(QtCore.QRect(180, 60, 91, 21))
        self.pbBondStartNowBack.setObjectName("pbBondStartNowBack")
        ...
        self.dtCureStartBack.setGeometry(QtCore.QRect(140, 40, 141, 21))
        ...
        self.pbCureStopNowBack.setGeometry(QtCore.QRect(140, 100, 141, 21))
        self.pbCureStopNowBack.setObjectName("pbCureStopNowBack")
        self.pbCureStartNowBack = QtWidgets.QPushButton(self.frame_4)
        self.pbCureStartNowBack.setGeometry(QtCore.QRect(140, 60, 141, 21))
        ...
        self.dtCureStopBack.setGeometry(QtCore.QRect(140, 80, 141, 21))
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(110, 0, 91, 19))
        self.lineEdit_2.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_2.setReadOnly(True)
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.frame_11 = QtWidgets.QFrame(Form)
        self.frame_11.setGeometry(QtCore.QRect(630, 20, 301, 541))
        self.frame_11.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_11.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_11.setObjectName("frame_11")
        self.label_14 = QtWidgets.QLabel(self.frame_11)
        self.label_14.setGeometry(QtCore.QRect(10, 360, 181, 16))
        self.label_14.setObjectName("label_14")
        self.frame_6 = QtWidgets.QFrame(self.frame_11)
        self.frame_6.setGeometry(QtCore.QRect(10, 40, 281, 301))
        self.frame_6.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_6.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_6.setObjectName("frame_6")
        self.ckWirebondsInspectedFront = QtWidgets.QCheckBox(self.frame_6)
        self.ckWirebondsInspectedFront.setGeometry(QtCore.QRect(0, 260, 241, 17))
        ...
        self.lineEdit_42.setGeometry(QtCore.QRect(1, 280, 181, 20))
        ...
        self.cbWirebondsRepairedUserFront.setGeometry(QtCore.QRect(180, 280, 101, 21))
        ...
        self.lineEdit_18.setGeometry(QtCore.QRect(0, 40, 171, 21))
        self.lineEdit_18.setReadOnly(True)
        self.lineEdit_18.setObjectName("lineEdit_18")
        self.dWirebondingFront = QtWidgets.QDateEdit(self.frame_6)
        self.dWirebondingFront.setGeometry(QtCore.QRect(170, 40, 111, 21))
        ...
        self.label_6.setGeometry(QtCore.QRect(0, 200, 261, 51))
        self.label_6.setWordWrap(True)
        self.label_6.setObjectName("label_6")
        self.pbBondStartNowFront = QtWidgets.QPushButton(self.frame_6)
        self.pbBondStartNowFront.setGeometry(QtCore.QRect(180, 60, 91, 21))
        self.pbBondStartNowFront.setObjectName("pbBondStartNowFront")
        self.label_12 = QtWidgets.QLabel(self.frame_11)
        self.label_12.setGeometry(QtCore.QRect(10, 20, 171, 21))
        self.label_12.setObjectName("label_12")
        self.frame_7 = QtWidgets.QFrame(self.frame_11)
        self.frame_7.setGeometry(QtCore.QRect(10, 390, 281, 141))
        ...
        self.dtCureStartFront.setGeometry(QtCore.QRect(140, 40, 141, 21))
        ...
        self.pbCureStopNowFront.setGeometry(QtCore.QRect(140, 100, 141, 21))
        self.pbCureStopNowFront.setObjectName("pbCureStopNowFront")
        self.pbCureStartNowFront = QtWidgets.QPushButton(self.frame_7)
        self.pbCureStartNowFront.setGeometry(QtCore.QRect(140, 60, 141, 21))
        ...
        self.dtCureStopFront.setGeometry(QtCore.QRect(140, 80, 141, 21))
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(100, 0, 91, 19))
        self.lineEdit_3.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_3.setReadOnly(True)
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.frame_12 = QtWidgets.QFrame(Form)
        self.frame_12.setGeometry(QtCore.QRect(10, 510, 281, 201))
        ...
        self.frame_13.setGeometry(QtCore.QRect(310, 510, 281, 201))
        self.frame_13.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_13.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_13.setObjectName("frame_13")
        self.pbDeleteCommentEncap = QtWidgets.QPushButton(self.frame_13)
        self.pbDeleteCommentEncap.setEnabled(True)
        ...
        self.pbAddCommentEncap.setEnabled(True)
        ...
        self.pteWriteCommentEncap.setEnabled(True)
        ...
        self.listCommentsEncap.setEnabled(True)
        ...
        self.frame_14.setGeometry(QtCore.QRect(10, 290, 281, 201))
        self.frame_14.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_14.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_14.setObjectName("frame_14")
        self.lineEdit_30 = QtWidgets.QLineEdit(self.frame_14)
        self.lineEdit_30.setGeometry(QtCore.QRect(0, 160, 61, 20))
        self.lineEdit_30.setReadOnly(True)
        self.lineEdit_30.setObjectName("lineEdit_30")
        self.pbCancelSearch = QtWidgets.QPushButton(self.frame_14)
        self.pbCancelSearch.setGeometry(QtCore.QRect(120, 180, 101, 21))
        self.pbCancelSearch.setObjectName("pbCancelSearch")
        self.leSearchStatus = QtWidgets.QLineEdit(self.frame_14)
        self.leSearchStatus.setGeometry(QtCore.QRect(60, 160, 221, 20))
        self.leSearchStatus.setText("")
        self.leSearchStatus.setReadOnly(True)
        self.leSearchStatus.setObjectName("leSearchStatus")
        self.pbAddPart = QtWidgets.QPushButton(self.frame_14)
        self.pbAddPart.setGeometry(QtCore.QRect(0, 180, 101, 21))
        self.pbAddPart.setObjectName("pbAddPart")
        self.lwPartList = QtWidgets.QListWidget(self.frame_14)
        self.lwPartList.setGeometry(QtCore.QRect(0, 0, 281, 161))
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit_43.setText(_translate("Form", "Pull strength avg (g)"))
        ...
        self.pbGoBatchSylgard.setText(_translate("Form", "go to"))
        self.pbGoBatchBondWire.setText(_translate("Form", "go to"))
        self.pbGoBatchWedge.setText(_translate("Form", "go to"))
        ...
        self.pbBondStartNowBack.setText(_translate("Form", "set to now"))
        ...
        self.lineEdit_2.setText(_translate("Form", "BACK SIDE"))
        ...
        self.label_6.setText(_translate("Form", "NOTE:  Channels should be a comma-separated list of values.  ex. 1, 3, 4, ..."))
        self.pbBondStartNowFront.setText(_translate("Form", "set to now"))
        ...
        self.lineEdit_3.setText(_translate("Form", "FRONT SIDE"))
        ...
        self.lineEdit_30.setText(_translate("Form", "Status:"))
