...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lwPartList.setGeometry(QtCore.QRect(490, 60, 281, 201))
        self.lwPartList.setObjectName("lwPartList")
        self.pbGoToPart = QtWidgets.QPushButton(Form)
        self.pbGoToPart.setGeometry(QtCore.QRect(600, 290, 171, 21))
        self.pbGoToPart.setObjectName("pbGoToPart")
        self.label = QtWidgets.QLabel(Form)
        self.label.setGeometry(QtCore.QRect(490, 40, 191, 16))
        ...
        self.leStatus.setGeometry(QtCore.QRect(550, 260, 221, 20))
        ...
        self.lineEdit_26.setGeometry(QtCore.QRect(490, 260, 61, 20))
        self.lineEdit_26.setReadOnly(True)
        self.lineEdit_26.setObjectName("lineEdit_26")
        self.pbClearResults = QtWidgets.QPushButton(Form)
        self.pbClearResults.setGeometry(QtCore.QRect(490, 290, 101, 21))
        self.pbClearResults.setObjectName("pbClearResults")
        self.label_6 = QtWidgets.QLabel(Form)
        self.label_6.setGeometry(QtCore.QRect(60, 360, 351, 16))
        ...
        self.ckUseDate.setGeometry(QtCore.QRect(310, 120, 71, 21))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(_translate("Form", "NOTE:  DB search is currently disabled"))
        ...
        self.cbShape.setItemText(8, _translate("Form", "Halfmoon"))
        self.cbShape.setItemText(9, _translate("Form", "Full+Three"))
