...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_3.setGeometry(QtCore.QRect(10, 300, 101, 17))
        ...
        self.label_6.setGeometry(QtCore.QRect(800, 120, 71, 17))
        self.label_6.setObjectName("label_6")
        self.label_8 = QtWidgets.QLabel(Form)
        self.label_8.setEnabled(True)
        self.label_8.setGeometry(QtCore.QRect(390, 300, 291, 16))
        self.label_8.setObjectName("label_8")
        self.frame = QtWidgets.QFrame(Form)
        self.frame.setGeometry(QtCore.QRect(10, 320, 311, 111))
        ...
        self.frame_3.setGeometry(QtCore.QRect(10, 140, 881, 141))
        self.frame_3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_3.setObjectName("frame_3")
        self.cbGrade6 = QtWidgets.QComboBox(self.frame_3)
        self.cbGrade6.setGeometry(QtCore.QRect(790, 120, 81, 21))
        ...
        self.cbGrade2.setGeometry(QtCore.QRect(790, 40, 81, 21))
        ...
        self.cbGrade1.setGeometry(QtCore.QRect(790, 20, 81, 21))
        ...
        self.lineEdit_31.setGeometry(QtCore.QRect(790, 0, 81, 21))
        ...
        self.cbGrade5.setGeometry(QtCore.QRect(790, 100, 81, 21))
        ...
        self.cbGrade4.setGeometry(QtCore.QRect(790, 80, 81, 21))
        ...
        self.cbGrade3.setGeometry(QtCore.QRect(790, 60, 81, 21))
        ...
        self.dsbMaxThickness1 = QtWidgets.QDoubleSpinBox(self.frame_3)
        self.dsbMaxThickness1.setGeometry(QtCore.QRect(660, 20, 101, 21))
        self.dsbMaxThickness1.setReadOnly(False)
        self.dsbMaxThickness1.setDecimals(3)
        self.dsbMaxThickness1.setMinimum(-1.0)
        self.dsbMaxThickness1.setMaximum(1000.0)
        self.dsbMaxThickness1.setSingleStep(0.1)
        self.dsbMaxThickness1.setObjectName("dsbMaxThickness1")
        self.lineEdit_33 = QtWidgets.QLineEdit(self.frame_3)
        self.lineEdit_33.setGeometry(QtCore.QRect(660, 0, 101, 21))
        self.lineEdit_33.setReadOnly(True)
        self.lineEdit_33.setObjectName("lineEdit_33")
        self.dsbMaxThickness6 = QtWidgets.QDoubleSpinBox(self.frame_3)
        self.dsbMaxThickness6.setGeometry(QtCore.QRect(660, 120, 101, 21))
        self.dsbMaxThickness6.setReadOnly(False)
        self.dsbMaxThickness6.setDecimals(3)
        self.dsbMaxThickness6.setMinimum(-1.0)
        self.dsbMaxThickness6.setMaximum(1000.0)
        self.dsbMaxThickness6.setSingleStep(0.1)
        self.dsbMaxThickness6.setObjectName("dsbMaxThickness6")
        self.dsbMaxThickness5 = QtWidgets.QDoubleSpinBox(self.frame_3)
        self.dsbMaxThickness5.setGeometry(QtCore.QRect(660, 100, 101, 21))
        self.dsbMaxThickness5.setReadOnly(False)
        self.dsbMaxThickness5.setDecimals(3)
        self.dsbMaxThickness5.setMinimum(-1.0)
        self.dsbMaxThickness5.setMaximum(1000.0)
        self.dsbMaxThickness5.setSingleStep(0.1)
        self.dsbMaxThickness5.setObjectName("dsbMaxThickness5")
        self.dsbMaxThickness2 = QtWidgets.QDoubleSpinBox(self.frame_3)
        self.dsbMaxThickness2.setGeometry(QtCore.QRect(660, 40, 101, 21))
        self.dsbMaxThickness2.setReadOnly(False)
        self.dsbMaxThickness2.setDecimals(3)
        self.dsbMaxThickness2.setMinimum(-1.0)
        self.dsbMaxThickness2.setMaximum(1000.0)
        self.dsbMaxThickness2.setSingleStep(0.1)
        self.dsbMaxThickness2.setObjectName("dsbMaxThickness2")
        self.dsbMaxThickness4 = QtWidgets.QDoubleSpinBox(self.frame_3)
        self.dsbMaxThickness4.setGeometry(QtCore.QRect(660, 80, 101, 21))
        self.dsbMaxThickness4.setReadOnly(False)
        self.dsbMaxThickness4.setDecimals(3)
        self.dsbMaxThickness4.setMinimum(-1.0)
        self.dsbMaxThickness4.setMaximum(1000.0)
        self.dsbMaxThickness4.setSingleStep(0.1)
        self.dsbMaxThickness4.setObjectName("dsbMaxThickness4")
        self.dsbMaxThickness3 = QtWidgets.QDoubleSpinBox(self.frame_3)
        self.dsbMaxThickness3.setGeometry(QtCore.QRect(660, 60, 101, 21))
        self.dsbMaxThickness3.setReadOnly(False)
        self.dsbMaxThickness3.setDecimals(3)
        self.dsbMaxThickness3.setMinimum(-1.0)
        self.dsbMaxThickness3.setMaximum(1000.0)
        self.dsbMaxThickness3.setSingleStep(0.1)
        self.dsbMaxThickness3.setObjectName("dsbMaxThickness3")
        self.frame_4 = QtWidgets.QFrame(Form)
        self.frame_4.setGeometry(QtCore.QRect(390, 320, 331, 51))
        ...
        self.label_7.setGeometry(QtCore.QRect(670, 120, 121, 17))
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit_33.setText(_translate("Form", "Max thick (mm)"))
        self.lineEdit_32.setText(_translate("Form", "Uploaded file"))
        self.pbAddFile.setText(_translate("Form", "Select file"))
        self.label_7.setText(_translate("Form", "Maximum thickness"))
