...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.sbSensorStepID = QtGui.QSpinBox(Form)
        self.sbSensorStepID.setGeometry(QtCore.QRect(100, 10, 61, 21))
        self.sbSensorStepID.setObjectName(_fromUtf8("sbSensorStepID"))
        ...
        self.pbSensorStepNew = QtGui.QPushButton(Form)
        self.pbSensorStepNew.setGeometry(QtCore.QRect(200, 12, 71, 21))
        self.pbSensorStepNew.setObjectName(_fromUtf8("pbSensorStepNew"))
        self.pbSensorStepEdit = QtGui.QPushButton(Form)
        self.pbSensorStepEdit.setGeometry(QtCore.QRect(280, 10, 71, 21))
        self.pbSensorStepEdit.setObjectName(_fromUtf8("pbSensorStepEdit"))
        self.pbSensorStepCancel = QtGui.QPushButton(Form)
        self.pbSensorStepCancel.setGeometry(QtCore.QRect(280, 40, 71, 21))
        self.pbSensorStepCancel.setObjectName(_fromUtf8("pbSensorStepCancel"))
        self.pbSensorStepSave = QtGui.QPushButton(Form)
        self.pbSensorStepSave.setGeometry(QtCore.QRect(200, 40, 71, 21))
        self.pbSensorStepSave.setObjectName(_fromUtf8("pbSensorStepSave"))
        ...
        self.lineEdit_21.setGeometry(QtCore.QRect(10, 380, 81, 21))
        self.lineEdit_21.setReadOnly(True)
        self.lineEdit_21.setObjectName(_fromUtf8("lineEdit_21"))
        self.leLoctiteBatch = QtGui.QLineEdit(Form)
        self.leLoctiteBatch.setGeometry(QtCore.QRect(90, 380, 71, 20))
        self.leLoctiteBatch.setObjectName(_fromUtf8("leLoctiteBatch"))
    ...
    def retranslateUi(self, Form):
        ...
        self.pbSensorStepNew.setText(_translate("Form", "New", None))
        self.pbSensorStepEdit.setText(_translate("Form", "Edit", None))
        self.pbSensorStepCancel.setText(_translate("Form", "Cancel", None))
        self.pbSensorStepSave.setText(_translate("Form", "Save", None))
        ...
        self.lineEdit_21.setText(_translate("Form", "Loctite batch#", None))
