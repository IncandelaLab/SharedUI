...
"before assembly"))
        ...
        self.cbVersion1.setItemText(1, _translate("Form", "generation"))
        self.cbVersion2.setItemText(0, _translate("Form", "preseries"))
        self.cbVersion2.setItemText(1, _translate("Form", "generation"))
        self.cbVersion3.setItemText(0, _translate("Form", "preseries"))
        self.cbVersion3.setItemText(1, _translate("Form", "generation"))
        self.cbVersion4.setItemText(0, _translate("Form", "preseries"))
        self.cbVersion4.setItemText(1, _translate("Form", "generation"))
        self.cbVersion5.setItemText(0, _translate("Form", "preseries"))
        self.cbVersion5.setItemText(1, _translate("Form", "generation"))
        self.cbVersion6.setItemText(0, _translate("Form", "preseries"))
        self.cbVersion6.setItemText(1, _translate("Form", "generation"))
